...
class NinetyOneDayBill extends StatefulWidget {
  const NinetyOneDayBill({super.key});

  @override
  State<NinetyOneDayBill> createState() => _NinetyOneDayBillState();
}

class _NinetyOneDayBillState extends State<NinetyOneDayBill> {
  @override
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image:
                              TreasuryBill91.treasuryBill91[index].image.image,
                        )),
                  ),
                  Text(
                    TreasuryBill91.treasuryBill91[index].comName,
                    style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        TreasuryBill91.treasuryBill91[index].yearHigh
                            .toStringAsFixed(4),
                        style: TextStyle(
                            fontSize:
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        TreasuryBill91.treasuryBill91[index].yearLow
                            .toStringAsFixed(4),
                        style: TextStyle(
                            fontSize:
                                MediaQuery.of(context).size.height / 56.26),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        TreasuryBill91.treasuryBill91[index].maturityDate,
                        style: TextStyle(
                            fontSize:
                                MediaQuery.of(context).size.height / 56.26),
                      ),
