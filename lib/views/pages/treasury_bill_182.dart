...
import 'package:radi_app/models/hundred_eighty_two.dart';
import 'package:radi_app/models/ninety_one.dart';
import 'package:radi_app/widgets/custom_appbar.dart';

class HundredEightyTwo extends StatefulWidget {
  const HundredEightyTwo({super.key});

  @override
  State<HundredEightyTwo> createState() => _HundredEightyTwoState();
}

class _HundredEightyTwoState extends State<HundredEightyTwo> {
  @override
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: TreasuryBill182
                              .treasuryBill182[index].image.image,
                        )),
                  ),
                  Text(
                    TreasuryBill182.treasuryBill182[index].comName,
                    style: TextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        TreasuryBill182.treasuryBill182[index].yearHigh
                            .toStringAsFixed(4),
                        style: TextStyle(
                            fontSize:
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        TreasuryBill182.treasuryBill182[index].yearLow
                            .toStringAsFixed(4),
                        style: TextStyle(
                            fontSize:
                                MediaQuery.of(context).size.height / 56.26),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        TreasuryBill182.treasuryBill182[index].maturityDate,
                        style: TextStyle(
                            fontSize:
                                MediaQuery.of(context).size.height / 56.26),
                      ),
